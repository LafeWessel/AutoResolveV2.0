...
void Player::setPlayerUnits(const vector<Unit> unitsI)
{
...
void Player::setReinforcements(const int ReinforceI)
{
...
//Calculates the correct autoresolve bonuses for the types of units
...
void Player::printData() const
{
	cout << "Player printData called" << endl
		...
		<< "Player faction: " << EnumerationConversions::to_string(fact) << endl
